...
describe('event model', () => {
  ...
  it('has a working virtual for weekday', () => {
    const date = new Date;
    const event = new Event({
      recipeId: testRecipe._id,
      date: date,
    ...
    expect(event.weekDay).toEqual('Thursday');
  });

  it('has a working virtual for day', () => {
    const date = new Date;
    const event = new Event({
      recipeId: testRecipe._id,
      date: date,
  ...
  it('has a working virtual for month', () => {
    const date = new Date;
    const event = new Event({
      recipeId: testRecipe._id,
      date: date,
  ...
  it('has a working virtual for year', () => {
    const date = new Date;
    const event = new Event({
      recipeId: testRecipe._id,
      date: date,
